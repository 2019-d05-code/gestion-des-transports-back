...
public class ReservationController {
	...
	public ResponseEntity<?> afficherReservationsVehicule(@PathVariable String immatriculation)
	...
	@GetMapping(value = "/chauffeur/reservationsAvecChauffeur")
	public List<ReservationChauffeurDTO> afficherReservationAvecNomChuaffeur() {

		return reservationServ.afficherReservationAvecNomChauffeur();
	}

	@PatchMapping(value = "chauffeur/planning")
	public ResponseEntity<AjoutChauffeurReservationDTO> ajouterChauffeurReservation(
			@RequestBody AjoutChauffeurReservationDTO ajoutChauffeurReservationDTO) {
		return ResponseEntity.ok(reservationServ.ajouterChauffeurAReservation(ajoutChauffeurReservationDTO));
	}
